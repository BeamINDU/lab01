...
[
  ...
  { menuId: "PL000", parentId: "", menuName: "Planning", icon: "", seq: 6, path: "/planning", actions: [] },
  ...
  { menuId: "L002", parentId: "LI000", menuName: "Line Packing 1", icon: "", seq: 2, path: "", actions: [1] },
  { menuId: "CAM3", parentId: "L002", menuName: "CAM 3", icon: "", seq: 1, path: "/live/3", actions: [1] },
  { menuId: "CAM1", parentId: "L002", menuName: "CAM 4", icon: "", seq: 2, path: "/live/4", actions: [1] },
]

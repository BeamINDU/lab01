...
import { Save, Download, Trash2, Square, Circle as CircleIcon, Edit3, Type, Edit2, Check, X, CheckIcon, ChevronUp, ChevronDown } from 'lucide-react';
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-gray-100 rounded">
              {/* Defect Color Categories */}
              <div
                className="w-4 h-4 rounded"
                style={{
                  backgroundColor: defectCategories.find((c) => c.id === defectType)?.color || 'transparent',
                }}
              ></div>
              <Type size={16} />
